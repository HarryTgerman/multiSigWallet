...
contract("MultiSigWallet", accounts => {
    ...
    const NUM_OF_CONFIRMATIONS_REQUIRED = 2;
    let wallet;
    beforeEach(async () => {
        wallet = await MultiSigWallet.new(owners, NUM_OF_CONFIRMATIONS_REQUIRED)
    })
    ...
    describe("executeTransaction", () => {
        ...
        //execute Transaction already executed should fail+
